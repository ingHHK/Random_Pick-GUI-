...
namespace WindowsFormsApplication1
{
    public partial class DisaplyWords : Form
    {
        ...
        public DisaplyWords(ref int[] checked_Category, int number)
        {
            InitializeComponent();
        ...
        private void answer_btn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < picking_Number; i++)
            {
                ...
                {
                    case 0:
                        textBox1.AppendText(red+Environment.NewLine);
                        break;
                    case 1:
                        textBox1.AppendText(blue + Environment.NewLine);
                        break;
                    case 2:
                        textBox1.AppendText(green + Environment.NewLine);
                        break;
                    case 3:
                        textBox1.AppendText(black + Environment.NewLine);
                        break;
                }
            }
        }
        ...
        public void Displaying_Words()
        {
            ...
            for(int i = 0; i < picking_Number; i++)
            {
                ...
                textBox1.AppendText(data.words[selected_Category[picking_word],selected_Number[i]] + Environment.NewLine);
            }
        }
